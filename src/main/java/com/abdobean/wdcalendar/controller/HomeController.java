...
public class HomeController {
    ...
    public @ResponseBody  String getShopInJSON(@RequestParam("method") String method,@RequestParam("showdate")String showdate,@RequestParam("viewtype")String viewtype) {
       String res = "";
